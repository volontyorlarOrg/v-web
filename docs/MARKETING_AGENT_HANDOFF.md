# Volontyorlar Marketing Website — Final Agent Handoff

## Mission

You are responsible for turning the existing Volontyorlar public website repository into the production-grade **Volontyorlar marketing website**.
...
Volontyorlar was founded on **June 4, 2025** by **Arslon Rajabov** and **Parizoda Abdurakhimova** to help high school students discover and apply to meaningful volunteering opportunities.

Volontyorlar has expanded from simply reposting opportunities into actively:
...
It should own:
- Volontyorlar brand and public positioning;
- landing pages;
- public organization/about information;
- partner/social-proof presentation;
- explanations of how Volontyorlar works;
...
Those belong in the separate Volontyorlar application repository.
...
The current Volontyorlar documentation contains product assumptions that are now stale.
...
- official product name is Volontyorlar;
...
If the final Volontyorlar marketing design is deliberately one-theme, remove theme infrastructure rather than maintaining unused complexity.
...
- it reinforces Volontyorlar's product story;
...
Do not discard the existing Volontyorlar design explorations without reading them.
...
- correct Volontyorlar name/product scope/documentation;
...
- implement current Volontyorlar story and traction;
